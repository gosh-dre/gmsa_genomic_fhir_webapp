...
const Sample: FC<Props> = (props) => {
  ...
  return (
    <>
      ...
      <FieldSet type="date" name="sample.collectionDateTime" label="Sample collected date" />
      <FieldSet type="date" name="sample.receivedDateTime" label="Sample received date" />
